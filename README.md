...
- **Obsidian round-trip**: "Copy content" exports Markdown with an Obsidian properties block (title, author, source, dates, tags, comments); pasting such a note into the Add tab or uploading the `.md` file imports it back, fields and comments included
