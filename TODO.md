...
- [x] **[P3]** Add font size changer in fullscreen player — Display button (Type icon) next to speed/sleep timer; -/+ steps (75–175%); CSS variable `--reader-font-scale` scales `.article-content`, `.comment-content`, `.read-along-text` with headings in `em` for proportional scaling; persisted to localStorage + backend `reader_font_scale` setting (2026-04-16)
