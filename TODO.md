...
- [ ] **[P2]** Investigate Whisper dropping first ~7.5s of audio (title/author/date not transcribed) — may need to enrich Whisper prompt with more context, or add a short silence prefix to audio
