...
- [x] **[P2]** Fix LLM alignment title/author/karma confusion - merged into one element since TTS reads them as one sentence; also removed redundant URL from content/read-along tabs (already in header) (2026-02-15)
